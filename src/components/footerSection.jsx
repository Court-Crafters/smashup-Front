            ...
            <div className="col-xl-12 col-lg-12 col-md-12">
              <div className="single-footer-widget">
                <div className="contact-box">
                  <div className="subtitle" style={{ color: "#1a22b7" }}>Address</div>
                  <div className="widget-head" style={{ color: "#1a22b7" }}>Ready to get started?</div>
                  <div className="text" style={{ color: "#1a22b7" }}>
                  ...
                  <div className="info">
                    ...
                    <div className="link">
                      <a href="mailto:contact.tech@gmail.com"  style={{ color: "#1a22b7" }}>
                        contact@padel4passion.com
                      </a>{" "}
                      <br />
                      <a href="mailto:info@Niotech.com" style={{ color: "#1a22b7" }}>
                  ...
                  <div className="info">
                    ...
                    <div className="link" style={{ color: "#1a22b7" }}>
                      <a  style={{ color: "#1a22b7" }} href="tel:21314234323543">+216 20 752 696   </a> <br />
                      <a  style={{ color: "#1a22b7" }} href="tel:35234523452345">+216 25 064 521</a>
                    </div>
                  </div>
                </div>
              </div>
